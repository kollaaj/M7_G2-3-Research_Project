...
// data for starter hexagon components
const starters = [ 
...
// data for small potato hexagon components
const potatoes = [ 
...
// data for proud of hexagon components
const proud = [ 
...
// data for group hexagon components
const group = [ 
  ...
  return (
    <main className={styles.main} id='project'>
      <div className={styles.starterContainer}>
        ...
        <div className={styles.catecoriesWrapper}>
          <div className={styles.projectWrapper}>
            { starters.map(({id, title, subtitle, text}) => <HexagonsStarter key={id} title={title} subtitle={subtitle} text={text} />) }
          </div>
        </div>
      ...
      <div className={styles.potatoesContainer}>
        ...
        <div className={styles.catecoriesWrapper}>
          <div className={styles.projectWrapper}>
            { potatoes.map(({id, title, subtitle, text}) => <HexagonsPotatoes key={id} title={title} subtitle={subtitle} text={text} />) }
          </div>
        </div>
      </div>
      ...
      <div className={styles.proudContainer}>
        ...
        <div className={styles.catecoriesWrapper}>
          <div className={styles.projectWrapper}>
            { proud.map(({id, title, subtitle, text}) => <HexagonsProud key={id} title={title} subtitle={subtitle} text={text} />) }
          </div>
        </div>
      </div>
      ...
      <div className={styles.groupContainer}>
        ...
        <div className={styles.catecoriesWrapper}>
          <div className={styles.projectWrapper}>
            { group.map(({id, title, subtitle, text}) => <HexagonsGroup key={id} title={title} subtitle={subtitle} text={text} />) }
          </div>
        </div>
      </div>
